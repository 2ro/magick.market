# Magick Market - Architecture Documentation
...
Magick Market is a decentralized, Nostr-based e-commerce marketplace built with modern web technologies. The application leverages the Nostr protocol for data storage and synchronization, eliminating the need for traditional centralized databases.
...
Magick Market uses a **hybrid architecture**:
...
const ndk = new NDK({
	...
	cacheAdapter: new NDKCacheAdapterDexie({ dbName: 'magick-market-ndk' }),
})
