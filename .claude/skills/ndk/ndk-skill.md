...
NDK is the primary Nostr development kit with outbox-model support, designed for building Nostr applications with TypeScript/JavaScript. This reference is based on analyzing production usage in the Magick Market codebase.
...
- **Production Example**: Magick Market codebase
...
_This reference is based on NDK version used in production and real-world patterns from the Magick Market application._
