...
Magick Market uses the Nostr protocol for all data storage and communication. All products, orders, profiles, and marketplace data are stored as Nostr events on relays.
