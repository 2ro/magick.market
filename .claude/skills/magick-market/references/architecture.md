# Magick Market Architecture

## Overview

Magick Market is a full-stack decentralized e-commerce marketplace built on the Nostr protocol. It enables peer-to-peer commerce using Bitcoin Lightning payments.
