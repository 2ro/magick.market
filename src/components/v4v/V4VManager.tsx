 ...
 * adapter, labels, and config (e.g. `showEmoji: false`, `requireGrinCapable:
...
export const V4VManager = forwardRef<HTMLDivElement, V4VManagerProps>(function V4VManager(
	...
	// recipients to have a GRIN address; an auction adapter sets requireGrinCapable:false.
	const addDisabled =
		isChecking || isCheckingGrinAddress || !newRecipientNpub || (config.requireGrinCapable && !hasGrinAddress) || totalV4VPercentage === 0
