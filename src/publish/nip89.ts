...
export const MAGICK_MARKET_URL = 'https://magick.market'
export const MAGICK_MARKET_RELAY = 'wss://relay.magick.market'

/**
 * Creates a handler information event (kind 31990) for Magick Market
 ...
 * This identifies that the event was created by Magick Market
 *
 * @param appPubkey - The public key of the Magick Market application
...
export const createClientTag = (appPubkey: string, handlerId: string): [string, string, string, string] => {
	return ['client', 'Magick Market', `31990:${appPubkey}:${handlerId}`, MAGICK_MARKET_RELAY]
}
