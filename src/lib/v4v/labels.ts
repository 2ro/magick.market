...
export interface V4VConfig {
	...
	/** Require recipients to have a GRIN receiving address (sales-only). */
	requireGrinCapable: boolean
...
export const salesV4VLabels: V4VLabels = {
	alertText:
		'MM (Beta) Is Powered By Your Generosity. Your Contribution Is The Only Thing That Enables Us To Continue Creating Free And Open Source Solutions 🙏',
